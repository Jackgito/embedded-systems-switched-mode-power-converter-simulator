...
clean--2e-:
	-$(RM) ./main.cyclo ./main.d ./main.o ./main.su ./state_functions.cyclo ./state_functions.d ./state_functions.o ./state_functions.su ./uart_utils.cyclo ./uart_utils.d ./uart_utils.o ./uart_utils.su
